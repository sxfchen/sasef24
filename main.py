...
if prenatal:
    ...
    if pre_stress_input == "I have experienced stress, depression, and/or negative life events that have impacted my mental health during pregnancy.":
        pre_stress = st.slider('Level of stress experienced during gestation. 0 corresponds to low levels and max to debilitating', 0.0, 100.0)
...
if postnatal:
    ...
    if post_stress_input == "I have experienced stress, depression, and/or negative life events since my child was born.":
        post_stress = st.slider('Level of stress experienced since childbirth. 0 corresponds to low levels and max to debilitating', 0.0, 100.0)
